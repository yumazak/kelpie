...
export type ThreadProps = {
  ...
  /**
   * Rendered in the footer, directly above the composer. kelpie puts its
...
// kelpie renders no branch UI: the transcript is the service's, one branch per
// message, so the branch picker and its number/count are never meaningful here.
